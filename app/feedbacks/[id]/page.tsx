    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
          ...
          <span className="text-gray-900 dark:text-gray-100">-Sight</span>{' '}
          Feedbacks
        </h1>
...
<script type="module" src="https://feed-widget-rithvik.vercel.app/feedback-widget.js"></script>
...
function FeedBackWidget() {
  useEffect(() => {
    ...
    script.src = 'https://feed-widget-rithvik.vercel.app/feedback-widget.js';
    script.type = 'module';
